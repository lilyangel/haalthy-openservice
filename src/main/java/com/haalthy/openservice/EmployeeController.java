package com.haalthy.openservice;
...
import com.haalthy.openservice.persistence.UserMapper;
...
public class EmployeeController {
    ...
    @ResponseBody
    public Set getFoobarList() throws IOException {
//    	String resource = "com/haalthy/openservice/mybatis-config.xml";
//    	InputStream inputStream = Resources.getResourceAsStream(resource);
//    	SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(inputStream);
//    	SqlSession session=sqlSessionFactory.openSession();
//    	dao.setSqlSession(session);
//    	System.out.println(dao.getCountForUser());
